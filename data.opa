...
watch =      { name="watch"      port=5000 article=interactivity   srcs=@static_include_directory("watch") }
watch_slow = { name="watch_slow" port=5001 article=interactivity   srcs=@static_include_directory("watch_slow")}
counter =    { name="counter"    port=5002 article=db_intro        srcs=@static_include_directory("counter")}
iMage =      { name="iMage"      port=5003 article=image_intro     srcs=@static_include_directory("iMage")}
iMage_01 =   { name="iMage-01"   port=5004 article=image_resources srcs=@static_include_directory("iMage-01")}
iMage_02 =   { name="iMage-02"   port=5005 article=image_resources srcs=@static_include_directory("iMage-02")}
iMage_03 =   { name="iMage-03"   port=5006 article=image_resources srcs=@static_include_directory("iMage-03")}
