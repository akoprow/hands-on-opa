...
------------------------
++++
<span class="run"><A target="_blank" href="http://94.23.204.210:5000">Run</A></span>
++++
////
...
[NOTE]
=======================
For now the address of the demo is a bit scary (unless you like IP
addresses in your address bar). I'm working on improving it.
=======================
...
------------------------
++++
<span class="run"><A target="_blank" href="http://94.23.204.210:5001">Run</A></span>
++++
...
a monsterous post so let me stop here and I will continue in the next post
