...
------------------------
++++
<span class="run"><A target="_blank" href="http://tutorials.opalang.org/watch">Run</A></span>
++++
...
[source,opa]
---------------------
include::../examples/wach_fragment/fragment.opa[]
---------------------
++++
</div>
</div>
<span class="run"><A target="_blank" href="http://tutorials.opalang.org/watch_fragment">Run</A></span>
++++
